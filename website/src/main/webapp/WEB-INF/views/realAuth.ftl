    ...
    <script type="text/javascript">
        $(function () {
            ...
            function upload(imgId) {
                if ($("#photoFile" + imgId).val() === '') {
                    return;
                }
                var formData = new FormData();
                formData.append('photo', document.getElementById('photoFile' + imgId).files[0]);
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.type === "success") {
                            $("#uploadImg" + imgId).attr("src", data.filepath + "/" + data.filename);
                            $("#uploadImage" + imgId).val(data.filepath + "/" + data.filename);
                        } else {
                            alert(data.msg);
                        }
                    },
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="idCardItem">
                                    <div>
                                        ...
                                        <input type="file" id="photoFile1" style="display: none;">
                                    </div>
                                ...
                                <div class="idCardItem">
                                    <div>
                                        ...
                                        <input type="file" id="photoFile2" style="display: none;">
                                    </div>
