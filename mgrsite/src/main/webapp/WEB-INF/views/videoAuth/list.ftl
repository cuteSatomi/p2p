        ...
        <div class="col-sm-9">
            ...
            <div class="row">
                ...
                <form id="searchForm" class="form-inline" method="post"
                    ...
                    <div class="form-group">
                        <label>申请时间</label>
                        <input class="form-control" style="width: 130px;" type="text" name="beginDate"
                               autocomplete="off"
                               id="beginDate" value="${(qo.beginDate?string('yyyy-MM-dd'))!''}"/> 到
                        <input class="form-control" style="width: 130px;" type="text" name="endDate" autocomplete="off"
                               id="endDate" value="${(qo.endDate?string('yyyy-MM-dd'))!''}"/>
                    </div>
                    <div class="form-group">
